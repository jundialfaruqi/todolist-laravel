<div>
    <x-page-header title="Manajemen Peran" description="Kelola peran dan izin dalam sistem">
            ...
            <div class="card-body">
                <div class="max-w-md">
                    ...
                    <input type="text" wire:model.live.debounce.300ms="search"
                        placeholder="Cari berdasarkan nama peran..." class="form-input" />
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    ...
                                                    <div class="text-sm text-gray-500">Guard: {{ $role->guard_name }}
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">Belum ada peran</h3>
                        <p class="mt-1 text-sm text-gray-500">Mulai dengan membuat peran pertama Anda.</p>
                        <div class="mt-6">
                            <a href="{{ route('roles.create') }}" class="btn-primary" wire:navigate>
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
